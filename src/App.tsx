...
export default function App() {
  ...
  const images = {
    ...
    privacy: 'https://images.unsplash.com/photo-1633356122544-f134ef073bda?w=400&h=300&fit=crop',
    strategy: 'https://images.unsplash.com/photo-1552664730-d307ca884978?w=400&h=300&fit=crop',
    traction: 'https://images.unsplash.com/photo-1518611505868-48510c8b5e1d?w=400&h=300&fit=crop',
          ...
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '30px' }}>
              <div style={{ background: '#0f172a', border: '1px solid #334155', borderRadius: '8px', padding: '40px', textAlign: 'center' }}>
                ...
                <p style={{ color: '#cbd5e1', fontSize: '0.95rem', lineHeight: '1.7' }}>{t('team.daniloDes')}</p>
              </div>
              <div style={{ background: '#0f172a', border: '1px solid #334155', borderRadius: '8px', padding: '40px', textAlign: 'center' }}>
                ...
                <p style={{ color: '#cbd5e1', fontSize: '0.95rem', lineHeight: '1.7' }}>{t('team.eliasDes')}</p>
              </div>
              <div style={{ background: '#0f172a', border: '1px solid #334155', borderRadius: '8px', padding: '40px', textAlign: 'center' }}>
                ...
                <p style={{ color: '#cbd5e1', fontSize: '0.95rem', lineHeight: '1.7' }}>{t('team.sarahDes')}</p>
              </div>
            </div>
          </div>
        </section>
